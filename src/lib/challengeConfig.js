...
export const RULES = [
  ...
  },
  {
    icon: 'speaker',
    title: '읽기가 부담되면 듣기로',
    body: '영어 원문마다 듣기 파일이 있습니다. 듣기만 하셔도 인증으로 인정되지만, "들었어요" 버튼을 누르는 것만으로는 인증되지 않습니다 — 라이브러리에서 그날 분량을 실제로 재생해야 인증 버튼이 활성화됩니다.',
  },
  {
    icon: 'alert',
    title: '미인증 6회 = 킥아웃 대상',
  ...
  },
  {
    ...
    body: '이 기간에는 인증하지 않아도 미인증으로 집계되지 않고 스트릭도 끊기지 않습니다. 그래도 읽거나 들으셨다면 평소처럼 인증하셔도 됩니다.',
  },
];
